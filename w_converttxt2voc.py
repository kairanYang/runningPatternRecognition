...
def create_xml(fn,inseg,inw,inh,indep,infoldername,intruefn,pointlist):
	#global g_list
...
def Readtxt_and_tran2vocxml(psegment,pimgdep,pimgfoldername):
	...
	while(1):
		...
		if(len(str1)>0):
			...
			create_xml(pxmlfn,pinseg,pinw,pinh,pindep,pinfoldername,pintruefn,lstps)
